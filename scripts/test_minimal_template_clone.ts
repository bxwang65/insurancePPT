...
import { renderMinimalSavingsClone } from "../src/templates/minimal-savings-clone-renderer.ts";
...
const outDir = path.resolve("outputs/regression_minimal_savings_clone");
const workspace = path.join(outDir, "template-clone/minimal-savings");
...
const pptxPath = await renderMinimalSavingsClone({
  outDir,
